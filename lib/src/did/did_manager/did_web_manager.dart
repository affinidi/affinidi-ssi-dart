...
class DidWebManager extends DidManager {
  ...
  Future<String> buildVerificationMethodId(PublicKey publicKey) async {
    // Use JWK Thumbprint (RFC 7638) as the VM fragment.
    // Canonical JWK: required members only, in lexicographic order.
    // SHA-256 → base64url (no padding) → 43-char stable, collision-resistant ID.
