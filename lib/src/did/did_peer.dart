...
Future<DidDocument> _buildMultiKeysDoc(String did, List<String> agreementKeys,
  ...
  try {
    ...
    developer.log('Success created multi-key doc', name: 'DidPeer');
    ...
    developer.log('Error creating multi keys Did Document', name: 'DidPeer');
    throw SsiException(
      message: 'Error creating multi keys Did Document',
      code: SsiExceptionType.invalidDidPeer.code,
    );
  }
}
...
Future<DidDocument> _buildEDDoc(
  ...
  try {
    ...
    if (!multiCodecXKey.startsWith('6LS')) {
      developer.log('Error creating EDDoc', name: 'DidPeer');
      throw SsiException(
    ...
    developer.log('Success created EDDoc', name: 'DidPeer');
    return Future.value(
      DidDocument(
        context: context,
        id: id,
...
Future<DidDocument> _buildXDoc(
  ...
  try {
    ...
    developer.log('Success created XDDoc', name: 'DidPeer');
    return Future.value(
      DidDocument(
        context: context,
        id: id,
    ...
    developer.log('Error creating XDDoc', name: 'DidPeer');
    throw SsiException(
      message: 'Error creating XDDoc',
      code: SsiExceptionType.invalidDidPeer.code,
    );
  }
}
...
class DidPeer {
  ...
  static Future<DidDocument> create(
    ...
    try {
      ...
      developer.log('Error creating peer DID Document', name: 'DidPeer');
      throw SsiException(
        message: 'Error creating peer DID Document',
        code: SsiExceptionType.invalidDidDocument.code,
      );
    }
  }
  ...
  static Future<DidDocument> resolve(String did) {
    try {
      ...
      developer.log('Error resolving peer DID Document', name: 'DidPeer');
      throw SsiException(
        message: 'Error resolving peer DID Document',
        code: SsiExceptionType.invalidDidDocument.code,
      );
    }
  }
