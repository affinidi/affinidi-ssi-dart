...
class EmbeddedProofSuiteCreateOptions {
  ...
  /// A nonce is a random value, usually generated by the prover, included in the proof to ensure uniqueness of each proof instance and prevent replay attacks.
  final String? nonce;
