...
class DataIntegrityEddsaVerifier extends EmbeddedProofSuiteVerifyOptions
  ...
  Future<VerificationResult> verify(Map<String, dynamic> document,
    ...
    if (proof['cryptosuite'] != _eddsaCryptosuite) {
      return VerificationResult.invalid(
        errors: ['invalid cryptosuite, expected $_eddsaCryptosuite'],
      );
    }
