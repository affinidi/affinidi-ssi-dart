...
/// );
/// ```
class ParsedVpDataModelV2 extends VpDataModelV2 {
  ...
  factory ParsedVpDataModelV2.fromJson(dynamic input) {
    final json = jsonToMap(input);

    final context = getStringList(json, _P.context.key, mandatory: true);
    if (context.isEmpty || context.first != VpDataModelV2.contextUrl) {
      throw SsiException(
        message:
            'The first URI of @context property should always be ${VpDataModelV2.contextUrl}',
