...
void main() {
  group('JWT VC Data Model V1 - exp validation', () {
    ...
    test(
      'verifyIntegrity should return true when exp is not present',
      () async {
    ...
    test(
      'verifyIntegrity should return true when current time is before exp',
      () async {
        final credential = MutableVcDataModelV1.fromJson({
          '@context': [dmV1ContextUrl],
    ...
    test(
      'verifyIntegrity should return false when current time is after exp',
      () async {
        final credential = MutableVcDataModelV1.fromJson({
          '@context': [dmV1ContextUrl],
          'holder': {'id': signer.did},
