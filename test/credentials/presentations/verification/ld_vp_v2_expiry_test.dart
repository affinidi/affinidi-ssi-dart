...
void main() async {
  final v2Vp = UniversalPresentationParser.parse(
      VerifiablePresentationDataFixtures.v2VpWithExpiringVCString);
  ...
  group('VP LD V1 Expiry Verification', () {
    ...
    test(
        ...
        () async {
      final verificationStatus =
          await VpExpiryVerifier(getNow: _getFuture).verify(v2Vp);
    ...
    test(
        ...
        () async {
      final verificationStatus =
          await VpExpiryVerifier(getNow: _getPast).verify(v2Vp);
