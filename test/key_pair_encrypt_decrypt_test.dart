...
void main() {
  ...
  final Uint8List edSeedAlice = Uint8List.fromList([23, 28, 184, 139, 27, 60, 29, 178, 90, 221, 89, 151, 18, 227, 98, 69, 215, 91, 198, 90, 26, 92, 158, 24, 215, 111, 159, 43, 30, 171, 64, 18]);
  ...
  group('Test key pair encrypt decrypt', () {
    test('ed25519', () async {
      Ed25519KeyPair edKey = Ed25519KeyPair(privateKey: ed.newKeyFromSeed(edSeedAlice), keyId: keyId);
